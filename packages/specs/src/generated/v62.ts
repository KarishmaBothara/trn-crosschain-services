...
export type EthySigningRequest = EthySigningRequest_Ethereum | EthySigningRequest_XrplTx

export interface EthySigningRequest_Ethereum {
    __kind: 'Ethereum'
    value: EthereumEventInfo
}

export interface EthySigningRequest_XrplTx {
    __kind: 'XrplTx'
    value: Uint8Array
}
...
export type EventRouterError = EventRouterError_FailedProcessing | EventRouterError_NoReceiver

export interface EventRouterError_FailedProcessing {
    __kind: 'FailedProcessing'
    value: DispatchError
}

export interface EventRouterError_NoReceiver {
    __kind: 'NoReceiver'
}
...
export interface EthereumEventInfo {
    source: Uint8Array
    destination: Uint8Array
    message: Uint8Array
